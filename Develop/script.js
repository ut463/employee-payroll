...
const displayAverageSalary = function(employeesArray) {
  ...
  const totalMoney = employeesArray.reduce((acc, employee) => acc + employee.salary, 0)
  const averageSalary = totalMoney / employeesArray.length;
}
...
const getRandomEmployee = function(employeesArray) {
  ...
  const randomEmployee = employeesArray[randomMath]
}
